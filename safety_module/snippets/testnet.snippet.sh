...
fundFromPool(){
    erdpy contract call ${ADDRESS} --recall-nonce --gas-limit=1000000000 --proxy=${PROXY} --pem=${BUSD_POOL} --chain=${CHAIN_ID} --function=ESDTTransfer --arguments ${ESDT_BUSD_TICKER} 50015 0x66756e6446726f6d506f6f6c --send
}
